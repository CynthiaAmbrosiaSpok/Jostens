...
public class ExcelUtil {
	...
	private static String path = System.getProperty("user.dir") + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator + "com" + File.separator + "jostens" + File.separator + "qa" + File.separator + "testdata" + File.separator + "newJostens.xlsx";
